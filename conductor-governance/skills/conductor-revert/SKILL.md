...
**PROTOCOL: Before reverting, determine which conductor scope to operate in.**

This gate implements the **Subconductor Resolution Protocol** defined in `AGENTS.md`. You MUST NOT skip this step.

1.  **Check for user input.** If the user provided a track name or target, analyze it to identify if it targets a specific subrepo.
